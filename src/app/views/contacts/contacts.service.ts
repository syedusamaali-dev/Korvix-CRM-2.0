...
export class ContactsService {
  private initialContacts: Contact[] = [
    {
      ...
      notes: [
        'Prefers morning phone calls.',
        'Key decision maker for Q3 renewal.',
      ],
      deals: [
        {
          id: 1,
      ...
      tasks: [
        {
          id: 1,
          title: 'Send revised SLA document',
          dueDate: '2026-08-05',
          status: 'Pending',
        },
      ],
      timeline: [
        {
          ...
          description: 'Discussed cloud migration scale.',
        ...
        },
        {
          ...
          type: 'email',
          title: 'Proposal Sent',
          description: 'Emailed pricing breakdown.',
      ...
      timeline: [
        {
          ...
          description: 'Reviewed API webhooks.',
          timestamp: '2026-07-27 02:00 PM',
        },
      ],
    },
    {
  ...
  addContact(contact: Contact): void {
    const updated = [contact, ...this.contactsSubject.value];
    this.contactsSubject.next(updated);
  }

  deleteContacts(ids: number[]): void {
    const updated = this.contactsSubject.value.filter(
      (c) => !ids.includes(c.id),
    );
    this.contactsSubject.next(updated);
  }
